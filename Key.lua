...
local Config = {
    ...
    ServiceId       = 27982, -- Your PlatoBoost Service ID
    PlatoSecret     = "c6fa5ed6-6fa8-44c3-bb00-3a422df6d449", -- Your PlatoBoost Secret Key
    ...
    ShowDiscord     = true,
    DiscordURL      = "https://discord.gg/exgHpYQpuk",
    ...
    HubName         = "NNVN Hub", -- The main title shown at the top of the GUI
    HubDescription  = "SharkBite2 Script" -- The text shown below the title
}
